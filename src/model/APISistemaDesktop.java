...
//        }
        ...
        do {
            ...
            if (i >= meses.size() ||
                ...
                if(categoria.equals("Saldo")){
                    int saldo = 0;
                    for(Movimentacao m: meses.get(i).getMovimentacoes()){
                        if (m instanceof Receita) {
                            saldo += m.getValor();
                        } else{
                            saldo -= m.getValor();
                    ...
                    resultado.add(saldo);
                } else if (categoria.equals("Total Despesas")){
                    int total = 0;
                    for(Movimentacao m: meses.get(i).getMovimentacoes()){
                    ...
                    resultado.add(total);
                } else if (categoria.equals("Total Receitas")){
                    int total = 0;
                    for(Movimentacao m: meses.get(i).getMovimentacoes()){
                        if (m instanceof Receita) {
                            total += m.getValor();
